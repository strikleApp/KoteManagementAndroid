...
public class UsersActivity extends Fragment implements BottomNavigationView.OnNavigationItemSelectedListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            ft.add(R.id.flFragment, viewUserFragment, "viewUserFragment").add(R.id.flFragment, addUserFragment, "addUserFragment").add(R.id.flFragment, deleteUserFragment, "deleteUserFragment").hide(viewUserFragment).hide(deleteUserFragment).commit();
