...
import com.android.kotemanagement.databinding.FragmentUserSuperAdminBinding;
...
public class UserSuperAdminFragment extends Fragment {
    private FragmentUserSuperAdminBinding binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        binding = FragmentUserSuperAdminBinding.inflate(inflater, container, false);
    ...
    private void filterRecords(String query) {
        if (query == null || query.trim().isEmpty()) {
            ...
            for (Records record : cachedRecords) {
                if ((record.getArmyNumber() != null && record.getArmyNumber().toLowerCase().contains(query.toLowerCase())) || (record.getName() != null && record.getName().toLowerCase().contains(query.toLowerCase())) || (record.getRank() != null && record.getRank().toLowerCase().contains(query.toLowerCase())) || (record.getDate() != null && record.getDate().toLowerCase().contains(query.toLowerCase())) || (record.getAction() != null && record.getAction().toString().toLowerCase().contains(query.toLowerCase()))) {
